# Quick Start Guide - Parking Reservation System

This guide will help you quickly set up and run both the backend and frontend of the Parking Reservation System.
...
```bash
git clone https://github.com/vstanisic5124m/ParkingReservationAppFront.git --->front code source
git clone https://github.com/vstanisic5124m/ParkingReservationAppBack.git ---> back code source
cd ...
```
